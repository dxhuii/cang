  ...
  shortcuts: [
    {
      ...
      'btn-primary': 'btn-base px-4 py-2 rounded text-$c-text-btn bg-$c-primary hover:bg-$c-primary-active',
      ...
      'border-aside': 'border-gray-100 dark:border-warm-gray-800',
      'border-aside-t': 'border-t border-aside',
      'border-aside-b': 'border-b border-aside',
      'border-aside-l': 'border-l border-aside',
      'border-aside-r': 'border-r border-aside',
